...
class IMUDashboard(QMainWindow):
    def __init__(self, loop: asyncio.AbstractEventLoop):
        ...
        self.plot_iis3dwb_x = PlotWidget("IIS3DWB X (g)", 'r', maxlen=500)
        self.plot_iis3dwb_y = PlotWidget("IIS3DWB Y (g)", 'g', maxlen=500)
        self.plot_iis3dwb_z = PlotWidget("IIS3DWB Z (g)", 'b', maxlen=500)
        
        self.plot_gyro_x = PlotWidget("ICM45686 Gyro X (dps)", 'r', maxlen=500)
        self.plot_gyro_y = PlotWidget("ICM45686 Gyro Y (dps)", 'g', maxlen=500)
        self.plot_gyro_z = PlotWidget("ICM45686 Gyro Z (dps)", 'b', maxlen=500)
        
        self.plot_mag_x = PlotWidget("IIS2MDC Mag X (mG)", 'r', maxlen=500)
        self.plot_mag_y = PlotWidget("IIS2MDC Mag Y (mG)", 'g', maxlen=500)
        self.plot_mag_z = PlotWidget("IIS2MDC Mag Z (mG)", 'b', maxlen=500)
        
        self.plot_angle_x = PlotWidget("SCL3300 Angle X (deg)", 'r', maxlen=500)
        self.plot_angle_y = PlotWidget("SCL3300 Angle Y (deg)", 'g', maxlen=500)
        self.plot_angle_z = PlotWidget("SCL3300 Angle Z (deg)", 'b', maxlen=500)
